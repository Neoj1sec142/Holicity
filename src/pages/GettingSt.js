    ...
    if(props.user){
        return(
            <Card style={{maxWidth: '60%', marginTop: '5em', textAlign: 'center'}} className="position-absolute top-50 start-50 translate-middle">
                ...
                <Card.Text>
                    You just being here gives the world hope. Welcome to Holicity, a holistic approach to
                    a greener earth. Holicity social platform for people to commune, share, and reminsce 
                    about hacks, tips, tricks, and any ways possible that we can contribute to helping 
                    restore the health of our home. As with being a site thats built for improvement, 
                    there is a type of post or blog you may choose to use to suggest ways to improve the app 
                    as well as a link to contact Holicity and offer any suggestions or ideas. 
                    Any and all suggestions are appreciated as we wish to make the app
